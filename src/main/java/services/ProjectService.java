...
public class ProjectService extends BaseService {
    ...
    public static Response get(String jsonName) {
        ...
        switch (jsonName) {
            case "request/getAllProjects":
                responseClass = ProjectResponse[].class; // lista
                break;

            case "request/getFindProjectID":
                responseClass = ProjectResponse.class; // objeto
                break;

            default:
                throw new RuntimeException("JsonName no reconocido en ProjectService.get(): " + jsonName);
        }

        return get(jsonName, responseClass, setParams());
    }
    ...
    public static void defineProjectId(String p_nameProject) {
        ...
        ProjectResponse[] projectResponseList = (ProjectResponse[]) APIManager.getLastResponse().getResponse();

        for (ProjectResponse project : projectResponseList) {
